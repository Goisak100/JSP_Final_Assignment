...
export default function UpdateProduct() {
    ...
    const fetchBookDetailData = async() => {
        try {
            const response = await axios.get("https://158.247.246.106:8443/api/book/getBookDetail", {
                params: {
                    id: book_id,
                }
            })
    ...
    const updateBookDetailData = async(event) => {
        ...
        try {
            await axios.post("https://158.247.246.106:8443/api/book/updateBookDetail", formData, {
                headers: {
