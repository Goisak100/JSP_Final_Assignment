...
export default function OrderDetail() {
    ...
    useEffect(() => {
        ...
        const fetchOrderDetails = async() => {
            try {
                const response = await axios.post("${process.env.REACT_APP_SERVER_HOST}/api/getOrderDetails", null, config)
        ...
        const fetchUserInformations = async() => {
            try {
                const response = await axios.post("${process.env.REACT_APP_SERVER_HOST}/api/getUserInformationByOrderId", null, config)
